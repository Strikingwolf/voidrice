...
---CONFIG
------------------------------------------------------------------------
myFont          = "xft:monospace:regular:pixelsize=12"
...
myStartupHook = do
          ...
          spawnOnce "compton &"
          spawnOnce "feh --bg-scale /home/crochelle/Downloads/mountfog.jpg &"
          setWMName "LG3D"
...
myKeys =
    ...
    --- Dmenu Scripts (Alt+Ctr+Key)
        , ("M-<Space>", spawn "dmenu_run -l 20 -fn 'monospace:size=10' -nb '#190c19' -nf '#b577b6' -sb '#311d32' -sf '#54a5a2' -p 'launch:'")

    --- My Applications (Super+Alt+Key)
        , ("M-M1-a", spawn (myTerminal ++ " -e ncpamixer"))
        , ("M-M1-b", spawn ("surf duckduckgo.com"))
        , ("M-M1-c", spawn (myTerminal ++ " -e cmus"))
        , ("M-M1-e", spawn ("surf https://outlook.office365.com/mail/inbox/"))
        , ("M-M1-f", spawn (myTerminal ++ " -e sh ./.config/vifm/scripts/vifmrun"))
        , ("M-M1-i", spawn (myTerminal ++ " -e irssi"))
        , ("M-M1-j", spawn (myTerminal ++ " -e joplin"))
        , ("M-M1-l", spawn (myTerminal ++ " -e lynx gopher://distro.tube"))
        , ("M-M1-m", spawn (myTerminal ++ " -e toot curses"))
        , ("M-M1-n", spawn (myTerminal ++ " -e newsboat"))
        , ("M-M1-p", spawn "flameshot gui")
        , ("M-M1-r", spawn (myTerminal ++ " -e ranger"))
        , ("M-M1-w", spawn (myTerminal ++ " -e wopr report.xml"))
        , ("M-M1-y", spawn ("surf youtube.com"))
	, ("M-S-x", spawn "i3lock-fancy")
